...
describe('Testing Mongo DB: express-rest-mongo', function () {
    var app, db
    ...
    describe('/:collection', function () {
        ...
        describe('POST', function () {
            it('should create document', function (done) {
                request(app).post('/api/v1/users/insert')
            ...
            it('can return an envelope', function (done) {
                request(app).post('/api/v1/users/insert?envelope=true')
                    .set('Content-Type', 'application/json')
                    .send({name:'Carl', email:'carl@example.com'})
                    .expect(201)
                    .end(function(err, res) {
    ...
    describe('/:collection/:id', function () {
        ...
        describe('POST', function () {
            it('should fail w/ full path', function (done) {
                request(app).post('/api/v1/users/insert/0001')
                    .set('Content-Type', 'application/json')
                    .expect(405)
                    .send()
                    .end(function(err, res) {
